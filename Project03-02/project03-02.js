...
let htmlCode = ""; // Declare and initialize htmlCode variable

for (let i = 0; i < captions.length; i++) { // Loop through captions array
   htmlCode += `<figure>
                  <img alt='' src='slide${i}.jpg' />
                  <figcaption>${captions[i]}</figcaption>
               </figure>`; // Add figure element with image and corresponding caption to htmlCode
}

document.getElementById("gallery").innerHTML = htmlCode; // Set the inner HTML of the "gallery" element
